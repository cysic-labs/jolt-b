...
fn test_sqrt_fq() {
    ...
    let two_inv = Babybear(0x3c000001);
...
fn test_field() {
    ...
    random_prime_field_tests::<Babybear>("Babybear".to_string());
    random_inversion_tests::<Babybear>("Babybear".to_string());
    random_small_field_tests::<Babybear>("Babybear".to_string());
}

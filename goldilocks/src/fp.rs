...
impl<'a> Add<&'a mut Goldilocks> for Goldilocks {
    type Output = Self;

    #[inline]
    fn add(self, rhs: &'a mut Goldilocks) -> Self::Output {
        self + *rhs
    }
}
...
impl<'a> AddAssign<&'a mut Goldilocks> for Goldilocks {
    #[inline]
    fn add_assign(&mut self, rhs: &'a mut Goldilocks) {
        *self = *self + *rhs;
    }
}
...
impl<'a> Sub<&'a mut Goldilocks> for Goldilocks {
    type Output = Self;

    #[inline]
    fn sub(self, rhs: &'a mut Goldilocks) -> Self::Output {
        self - *rhs
    }
}
...
impl<'a> SubAssign<&'a mut Goldilocks> for Goldilocks {
    #[inline]
    fn sub_assign(&mut self, rhs: &'a mut Goldilocks) {
        *self = *self - *rhs;
    }
}
...
impl<'a> Mul<&'a mut Goldilocks> for Goldilocks {
    type Output = Self;

    #[inline]
    fn mul(self, rhs: &'a mut Goldilocks) -> Self::Output {
        self * *rhs
    }
}
...
impl<'a> MulAssign<&'a mut Goldilocks> for Goldilocks {
    #[inline]
    fn mul_assign(&mut self, rhs: &'a mut Goldilocks) {
        *self = *self * *rhs;
    }
}
...
impl CanonicalDeserialize for Goldilocks {
    fn deserialize_with_mode<R: ark_serialize::Read>(
        ...
        if validate == Validate::Yes {
            if value_u64 >= super::MODULUS {
                return Err(ark_serialize::SerializationError::InvalidData);
            }
        }
        Ok(Goldilocks(u64::from_le_bytes(bytes)))
    }
}

impl Valid for Goldilocks {
    fn check(&self) -> Result<(), ark_serialize::SerializationError> {
        Ok(())
    }
}

impl CanonicalSerialize for Goldilocks {
    fn serialize_with_mode<W: ark_serialize::Write>(
        &self,
        mut writer: W,
        _compress: ark_serialize::Compress,
    ) -> Result<(), ark_serialize::SerializationError> {
        let bytes = self.to_canonical_u64().to_le_bytes();
